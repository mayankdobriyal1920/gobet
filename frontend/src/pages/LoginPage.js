...
export default function LoginPage(){
    ...
    return (
        <IonPage>
                ...
                <div className={"login_main_container_inner"}>
                    ...
                    <div className={"main_logo_and_slogan_container_header logo_section"}>
                        <div className={"main_welcome_header_logo_section"}>
                            <svg width={'53px'} height={'53px'} viewBox="0 0 24 24" fill="none">
                    ...
                    <div className={"main_form_container_section"}>
                        ...
                        <IonRow>
                            ...
                            <IonCol size={9}>
                                <input className={"form_input_section input"}
                                       ...
                                       value={phone}
                                       placeholder={"Phone Number"} type={"text"} required={true}/>
                            </IonCol>
                        </IonRow>
                        <IonRow className={"form_second_label_input"}>
                            <div className={"login_form_label"}>
                        ...
                        <IonRow>
                            <IonCol size={9}>
                                <input className={"form_input_section input"}
                                       ...
                                       placeholder={"OTP Password"} type={"text"} required={true}/>
                            </IonCol>
                            <IonCol size={3}>
                                <button onClick={callFunctionToLoginUser} disabled={phone?.length !== 10}
                        ...
                        <IonRow>
                            <IonCol>
                                <button onClick={callFunctionToValidateOtpAndLoginUser}
            ...
            <IonLoading isOpen={userAuthDetail?.loading} message={"Please Wait..."}/>
        </IonPage>
    )
}