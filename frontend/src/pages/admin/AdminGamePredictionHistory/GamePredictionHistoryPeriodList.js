...
export default function GamePredictionHistoryPeriodList() {
    ...
    const callFunctionToOpenSessionDetailPage = (data) => {
        data.session_date = predictionListData.session_date

        dispatch(actionToGetPredictionHistoryData(data, "prediction_result"));
