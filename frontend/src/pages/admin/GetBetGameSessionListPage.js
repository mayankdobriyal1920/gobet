        ...
        return (
            <div key={dataItems?.id} className="sysMessage__container-msgWrapper__item">
                <div className="sysMessage__container-msgWrapper__item-title">
                    <div>
                        <span className={"title"}>Platform: {dataItems?.betting_platform_name}</span>
                    </div>
                </div>
                <div className="sysMessage__container-msgWrapper__item-content">
                    <div><strong>Start time:</strong> {moment(dataItems?.start_time, 'HH:mm:ss').format('hh:mm A')}
                    </div>
                    <div><strong>End time:</strong> {moment(dataItems?.end_time, 'HH:mm:ss').format('hh:mm A')}
                    </div>
                                    ...
                                    : (gameSessionData?.length) ?
                                        <div className={"sysMessage__container_item"}>
                                            <Virtuoso
                                                ...
                                                totalCount={gameSessionData?.length}
                                                itemContent={index => renderVirtualElement(gameSessionData[index])}
                                            />
                                        </div>
                                        :
                                        <div className={"empty__container empty"}>
