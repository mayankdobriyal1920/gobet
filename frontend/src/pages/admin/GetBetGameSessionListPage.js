    ...
    return (
        <React.Fragment>
            <div className={"bet-content__box"}>
                {(userInfo?.role === 1) ?
                    <button className={"add_new_session_button_styl"} type={"button"} onClick={()=>callFunctionToSetIsAddEditSessionPopupOpen()}>
                        Add New Session
                    </button>:''
                }
                <div className={"infiniteScroll"}>
                    ...
                    <div className={"sysMessage__container session_container_active"}>
                        <div className="getbet-title getbet-line">
                            <div className="getbet-title-left"><span>Next Sessions</span></div>
                        </div>
                        <div className={"infiniteScroll__loading"}>
                            {loading ?
                                ...
                                : (gameSessionData?.length) ?
                                    <div className={"sysMessage__container_item"}>
                                        {(gameSessionData.map((dataItems)=> (
                                            <div key={dataItems?.id} className="sysMessage__container-msgWrapper__item">
                                                <div className="sysMessage__container-msgWrapper__item-title">
                                                    <div>
                                                        <span
                                                            className={"title"}>Platform: {dataItems?.betting_platform_name}</span>
                                                    </div>
                                                </div>
                                                <div className="sysMessage__container-msgWrapper__item-content">
                                                    <div><strong>Start
                                                        time:</strong> {moment(dataItems?.start_time, 'HH:mm:ss').format('hh:mm A')}
                                                    </div>
                                                    <div><strong>End
                                                        time:</strong> {moment(dataItems?.end_time, 'HH:mm:ss').format('hh:mm A')}
                                                    </div>
                                                    <div><strong>Game type:</strong> WIN GO</div>
                                                </div>
                                                {(userInfo?.role === 1) ?
                                                    <div className="sysMessage__container-msgWrapper__item-footer">
                                                        ...
                                                        <span
                                                            onClick={() => callFunctionToSetIsAddEditSessionPopupOpen(dataItems)}
                                                            className={`action_button update`}>
                                                            EDIT
                                                        </span>
                                                    </div> : ''
                                    ...
                                    <div className={"empty__container empty"}>
                                        ...
                                        <p>Next session data is not available</p>
                                    </div>
                            }
                        </div>
                    </div>
