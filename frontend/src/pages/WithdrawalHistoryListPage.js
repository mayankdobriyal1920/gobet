            ...
            <IonModal
                ...
                <IonContent className="ion-padding">
                    ...
                    <div className={"list_status_type"}>
                        <div className={`list_status_type_item ${statusTypeFilter === 'All' ? 'active' : ''}`} onClick={()=>callFunctionToApplyTypeFilter('All')}>All</div>
                        <div className={`list_status_type_item ${statusTypeFilter === 'Approved' ? 'active' : ''}`} onClick={()=>callFunctionToApplyTypeFilter('Approved')}>Approved</div>
                        <div className={`list_status_type_item ${statusTypeFilter === 'Pending' ? 'active' : ''}`} onClick={()=>callFunctionToApplyTypeFilter('Pending')}>Pending</div>
                    </div>
                </IonContent>
            </IonModal>
