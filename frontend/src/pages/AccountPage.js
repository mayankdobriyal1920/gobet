                    ...
                    <div className={"profile_account_main_userinfo_content"}>
                        <div className={"totalSavings__container"}>
                            <div className="totalSavings__container-header">
                                <div className="totalSavings__container-header-box">
                                    ...
                                    <p className="totalSavings__container-header__subtitle">
                                        ...
                                        <svg onClick={reloadMainBalance} xmlns="http://www.w3.org/2000/svg" className="svg-icon icon-refreshBalance"
                        ...
                        <div className="settingPanel__container">
                            ...
                            <div className="settingPanel__container-items">
                                <div onClick={()=>goToPage('/admin-game-result')} className="settingPanel__container-items__item ar-1px-b">
                                ...
                                <div onClick={()=>goToPage('/admin-withdrawal-pending-request')} className="settingPanel__container-items__item ar-1px-b">
                                    <div className="settingPanel__container-items__title">
